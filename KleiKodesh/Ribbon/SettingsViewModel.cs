...
namespace KleiKodesh.Ribbon
{
    public static class SettingsViewModel
    {
        ...
        static int _updateInterval = int.TryParse(Interaction.GetSetting(AppName, Section, "UpdateInterval"), out int result) ? result : 1;
    ...
    public class SettingsModel : INotifyPropertyChanged
    {
        ...
        void Commit()
        {
            ...
            SettingsViewModel.Ribbon?.InvalidateControl(Key.Replace("Show", ""));
        }
    }
}
